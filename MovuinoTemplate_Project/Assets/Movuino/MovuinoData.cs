...
namespace Movuino
{
    ...
    /// <summary>
	/// Data for the accelerometer and the gyroscope of Streamo
	/// </summary>
	public class StreamoSensorData : MovuinoData
    {
        /// <summary>
        /// Accelerometer data.
        /// </summary>
        ...
        public static string address = "/streamo";
        ...
        public override string ToString()
        {
            return string.Format("[StreamoSensorData] = "
            + "Accelerometer = "
            + accelerometer.ToString()
            + " Gyroscope = "
            + gyroscope.ToString()
    ...
    public class MovuinoSensorRep : MovuinoData
    {
        ...
        public static string address = "/repetitions";
